    ...
    <section id="prensa" className="relative bg-[#0A0806] overflow-hidden border-t border-white/[0.06]">
      ...
      <div className="relative z-10 w-full max-w-[1800px] mx-auto px-5 sm:px-8 md:px-[82px] py-24 sm:py-32 md:py-40">
        <div className="flex flex-col lg:flex-row lg:items-start gap-8 lg:gap-12">
          ...
          <Reveal dir="right" delay={120} className="w-full lg:w-[440px] shrink-0 flex">
            <article className="flex flex-col w-full rounded-[24px] sm:rounded-[33px] bg-[rgba(17,16,15,0.35)] backdrop-blur-[20px] border border-white/[0.06] p-6 sm:p-8">
